    ...
    Tables: {
      ...
      cj_orders: {
        Row: {
          ...
          created_at: string
          customer_revenue_azn: number | null
          error_message: string | null
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "cj_orders_cj_product_id_fkey"
            columns: ["cj_product_id"]
            isOneToOne: false
            referencedRelation: "cj_products"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "cj_orders_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
      ...
      cj_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "cj_products_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
