    ...
    <header className="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-xl">
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        ...
        <nav className="hidden items-center gap-6 2xl:flex">
          ...
          <Link to="/contest" className="flex items-center gap-1 whitespace-nowrap text-sm font-medium text-primary transition-colors hover:text-primary/80"><Trophy className="h-3.5 w-3.5" />Yarışma</Link>
