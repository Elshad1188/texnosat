        ...
        <div className="fixed bottom-16 right-3 z-50 flex h-[480px] w-[340px] flex-col rounded-2xl border border-border bg-card shadow-2xl md:bottom-4 md:right-4 md:w-[380px]">
          ...
          <div className="border-t border-border p-3 space-y-2">
            <button
              ...
              className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-primary/30 bg-primary/10 px-3 py-1.5 text-[11px] font-semibold text-primary transition-colors hover:bg-primary/20"
            >
