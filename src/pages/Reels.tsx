    ...
    >
      ...
      {currentReel && (
        <div className="absolute top-14 right-4 z-30 flex flex-col items-end gap-2 max-w-[55%]">
          <span className="inline-block rounded-lg bg-primary px-3 py-1.5 text-primary-foreground font-bold text-base shadow-lg">
            {(currentReel as any).custom_fields?.price_negotiable
              ? "Razılaşma yolu ilə"
      ...
      {showComments && currentReel && (
        <div
          ...
          className="absolute bottom-0 left-0 right-0 z-[110] flex flex-col rounded-t-3xl bg-background shadow-2xl"
          style={{ height: "65vh" }}
        ...
        >
          ...
          {user ? (
            <div className="shrink-0 border-t border-border bg-background px-3 py-3 pb-24 lg:pb-3">
              {replyingTo && (
